...
<div class="md:flex md:items-center">
    ...
    <form method="POST" action="{{route('imagen.store')}}" id="dropzone" class="dropzone border-dashed border-2 w-full h-80 rounded flex flex-col justify-center items-center bg-transparent" enctype="multipart/form-data">
    @csrf
